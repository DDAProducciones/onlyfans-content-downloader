...
| `scrollExtentInPercentage` | integer | 100 | `100` means 100%. Allows you to download only a portion of the user's media content. E.g. `50` would mean, that the code will download up to 50% of the page content. `100` means 100% (percentage), to download all media content. This configuration is useful if you just want the latest uploads from a certain user instead of having to iterate over all the media content again. It allows you to save yourself time.|
